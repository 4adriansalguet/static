<section id="section_2">
    <div class="section_2_content" data-aos="fade-up" data-aos-delay="50">
        <h2 data-aos="fade-up" data-aos-delay="100">Make Garcia Painting your one and only choice.</h2>
        <p data-aos="fade-up" data-aos-delay="150">NO JOB TOO SMALL! WE DO WHAT THE OTHER GUYS WON’T!</p>
        <div class="section_2_btn_container">
            <a href="#">
                <img src="public/images/common/call_button.jpg" alt="">
            </a>
        </div>
    </div>
</section>
